...
namespace xing\helper\yii\generators\crud;
...
class Generator extends \yii\gii\Generator
{
    ...
    public $viewPath;
    public $baseControllerClass = '\apps\backend\controllers\BaseController';
    public $indexWidgetType = 'grid';
    public $searchModelClass = '';
    public $module = '';

    private $modulePath = 'common\modules\\';
    /**
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['modelClass', 'baseControllerClass', 'module'], 'filter', 'filter' => 'trim'],
            [['modelClass', 'module'], 'required'],
...
//            'searchModelClass' => '搜索类',
    ...
    {
        $this->modelClass = preg_replace('/(.*)\\\\/', '', $this->modelClass);
        // 自动补全各参数路径
        preg_match_all('/[A-Z]/U', $this->modelClass, $arr);
        $dir = preg_replace('/([A-Z])/U', '-$1', $this->modelClass);
        $dir = trim(strtolower($dir), '-');

        $backendPath = 'apps\backend\modules\\' . $this->module . '\\';
        $this->viewPath = '@' . $backendPath . 'views\\' . $dir;
        $this->controllerClass = $backendPath . 'controllers\\' . $this->modelClass . 'Controller';
        $this->searchModelClass = 'common\\modules\\' . $this->module . '\\search\\' . $this->modelClass . 'Search';
        $this->modelClass = 'common\\modules\\' . $this->module . '\\' . $this->modelClass;
